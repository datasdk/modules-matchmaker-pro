...
return [
    ...
    'subject' => 'Der er oprettet et nyt projekt: id: {{ task.id }}',

    'html_template' => '
    <p><strong>Kære Admin</strong>,</p>

    <p>Der er netop blevet oprettet et nyt projekt i systemet.</p>
    ...
    Der er netop blevet oprettet et nyt projekt i systemet.
