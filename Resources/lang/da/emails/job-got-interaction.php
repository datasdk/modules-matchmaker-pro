...
return [
    ...
    'subject' => 'Dit projekt er blevet accepteret ( "{{ mytask.name }}" )',

    'html_template' => '
    <p><strong>Kære {{ mytask.user.first_name }}</strong>,</p>

    <p>Dit projekt er blevet <strong>accepteret af en virksomhed</strong>.</p>

    <p>Virksomhedens mandskab <strong>{{ task.name }}</strong> vil gerne </p>
    ...
    Dit projekt er blevet accepteret af en virksomhed.
