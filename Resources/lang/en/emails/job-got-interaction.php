...
return [
    ...
    'subject' => 'Your project has been accepted ("{{ mytask.name }}")',

    'html_template' => '
    <p><strong>Dear {{ mytask.user.first_name }}</strong>,</p>

    <p>Your project has been <strong>accepted by a company</strong>.</p>
    ...
    Your project has been accepted by a company.
